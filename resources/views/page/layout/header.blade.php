...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
  ...
  <div class="navbar-nav align-items-center flex-row">
    <div class="nav-item d-flex align-items-center" style="font-family: Times New Roman;text-align: center;font-weight: bold;">
      <img src="{{asset('store.jpeg')}}" width="70" height="40">
      <marquee>
       Adelia Florist | Sistem Informasi Penjualan untuk Pengelolaan Stok dan Transaksi | Dirancang Khusus untuk Kemudahan dan Akurasi Pengelola | {{ date('Y-m-d') }} <span id="clock"></span>
     </marquee>
   </div>
 </div>
 <!-- /Search -->
